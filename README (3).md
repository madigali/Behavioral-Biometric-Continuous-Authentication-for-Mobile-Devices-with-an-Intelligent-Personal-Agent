...
manuscript (`Search_Strategy.txt` and `Quality_Assessment_Scores.xlsx`,
also mirrored here for convenience).
...
│                                            snowballing)
├── 📄 data_extraction_tables.md          ← Extraction tables reproduced from the manuscript
│                                            (Tables 3, 6, 7, 8): performance metrics subset,
│                                            thematic/modality/ML-method distributions
│
...
> `Literature_Review_All80_References.xlsx` above and should not be
...
- ✅ Extraction tables reproduced from the manuscript (`data_extraction_tables.md`)
